...
套件安裝完成後，瀏覽器工具列會出現 ⚡ 圖示。

### 步驟五：設定 URL 規則

點擊工具列的 ⚡ 圖示開啟設定視窗，在「**Active URL Patterns**」新增要顯示面板的網址規則，例如：
...
- **Export .json**：將目前的篩選項目和 URL 規則匯出為 `.json` 檔案
- **Import .json**：從 `.json` 檔案還原設定
